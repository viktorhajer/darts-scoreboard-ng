  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(applicationStateService, soundService) {
        ...
        this.soundService = soundService; // document.addEventListener('touchmove',  (event: any) => {
    ...
    function () {
      ...
      _createClass(NumberPlateVisualComponent, [{
        ...
        value: function drawTable() {
          ...
          var svg = d3__WEBPACK_IMPORTED_MODULE_2__["select"]('#darts-table-plate').append('svg').attr('width', '94%').attr('height', '94%').attr('viewBox', '0 0 330 330');
